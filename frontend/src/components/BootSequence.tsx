...
const BOOT_LOG: BootLine[] = [
    { text: "KnightKernel BIOS v1.0 — Initializing...", delay: 300 },
    ...
    { text: "████████████████████████████████ 100%", delay: 300 },
    { text: "", delay: 500 },
    { text: "knightkernel login: root", delay: 400 },
    { text: "Password: ████████", delay: 800 },
    { text: "", delay: 300 },
    { text: "Welcome to KnightKernel 1.0.0 (CS-330 CEP Spring 2026)", delay: 400 },
