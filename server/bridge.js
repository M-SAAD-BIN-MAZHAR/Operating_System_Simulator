...
class Bridge {
    ...
    /**
     * Spawns the knightkernel_engine process.
     */
    start() {
        const enginePath = path.join(__dirname, '../kernel/build/knightkernel_engine.exe');
        
        console.log(`[Bridge] Attaching to KnightKernel Engine at: ${enginePath}`);
